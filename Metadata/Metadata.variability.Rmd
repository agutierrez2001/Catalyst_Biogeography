...
write.xlsx(Surface_ranks, "samples_df_MLD_July2020_chla.rank.xlsx")
...
write.xlsx(DNA_metadata.rank.median, "samples_df_MLD_July2020_RANKED.xlsx")
...
git### Table only with Cruises information
...
ggsave("N_sample_watermass_catalyst.pdf", path = "R.Figures/Sample_distribution", dpi = 300, height = 4, width = 8)

### plot number of samples (histogram) in different projects
DNA_metadata <-  read_excel("samples_df_MLD_2April2020_RANKED.xlsx") %>%
    filter(Sample_Type == "Seawater")

g <- ggplot(DNA_metadata, aes(Project))
...
ggsave("N_sample_watermass_projects.pdf", path = "R.Figures/Sample_distribution", dpi = 300, height = 4, width = 8)
...
ggsave("N_sample_cruises.pdf", path = "R.Figures/Sample_distribution", dpi = 300, height = 4, width = 8)
...
ggsave("N_sample_watermass_EEZ.pdf", path = "R.Figures/Sample_distribution", dpi = 300, height = 4, width = 8)
...
ggsave("sample_counts_dens_layer.pdf", path = "R.Figures/Sample_distribution", dpi = 300, height = 4, width = 8)
...
ggsave("sample_counts_light_layer.pdf", path = "R.Figures/Sample_distribution", dpi = 300, height = 4, width = 8)
...
ggsave("sample_counts_month.pdf", path = "R.Figures/Sample_distribution", dpi = 300, height = 4, width = 8)
...
### ChlaTot
CairoPDF(file = "R.Figures/Metadata_distribution/Chla_ML_ProbDist_Water_mass.TS1.pdf", width = 5, height = 3) 
DNA_metadata.ML %>%
ggplot(aes(x=Temperature.CTD, group=Water_mass.TS1, fill=Water_mass.TS1)) +
    geom_line(stat="density", aes(color=Water_mass.TS1)) +
...
### Temperature
CairoPDF(file = "R.Figures/Metadata_distribution/Temp_ML_ProbDist_Water_mass.TS1.pdf", width = 5, height = 3) 
    DNA_metadata.ML %>%
    ggplot(aes(x=Temperature.CTD, group=Water_mass.TS1, fill=Water_mass.TS1)) +
...
### Salinity
CairoPDF(file = "R.Figures/Metadata_distribution/Sal_ML_ProbDist_Water_mass.TS1.pdf", width = 5, height = 3) 
    DNA_metadata.ML %>%
    ggplot(aes(x=Salinity.CTD, group=Water_mass.TS1, fill=Water_mass.TS1)) +
      geom_density(adjust=1.5, alpha=.4) +
...
### Nitrate
CairoPDF(file = "R.Figures/Metadata_distribution/Nitrate_ML_ProbDist_Water_mass.TS1.pdf", width = 5, height = 3) 
   DNA_metadata.ML %>%
     ggplot(aes(x=NO3, group=Water_mass.TS1, fill=Water_mass.TS1)) +
       geom_density(adjust=1.5, alpha=.4) +
...
### Silicate
CairoPDF(file = "R.Figures/Metadata_distribution/DRSi_ML_ProbDist_Water_mass.TS1.pdf", width = 5, height = 3) 
    DNA_metadata.ML %>%
     ggplot(aes(x=DRSi, group=Water_mass.TS1, fill=Water_mass.TS1)) +
       geom_density(adjust=1.5, alpha=.4) +
...
### Latitude 
CairoPDF(file = "R.Figures/Metadata_distribution/Latitude_ML_ProbDist_Water_mass.TS1.pdf", width = 5, height = 3) 
  DNA_metadata.ML %>%
     ggplot(aes(x=Latitude.CTD, group=Water_mass.TS1, fill=Water_mass.TS1)) +
    geom_density(adjust=1.5, alpha=.4) +
...
DNA_metadata.euphotic <- DNA_metadata.sw %>%
  ...
  CairoPDF(file = "R.Figures/Metadata_distribution/Seasonal_ProbDist_all_Water_mass.TS2.pdf", width = 5, height = 3) 
  DNA_metadata.sw %>%
...
## TEMPERATURE - 
  #Water mass
  CairoPDF(file = "R.Figures/Metadata_distribution/Temp_ML_watermass.pdf", width = 5, height = 3) 
  ...
  #Region
   CairoPDF(file = "R.Figures/Metadata_distribution/Temp_ML_area.pdf", width = 5, height = 3) 
  ...
  ## SALINITY - 
  #Water mass
  CairoPDF(file = "R.Figures/Metadata_distribution/Sal_ML_watermass.pdf", width = 5, height = 3) 
  ...
  #Region
   CairoPDF(file = "R.Figures/Metadata_distribution/Sal_ML_area.pdf", width = 5, height = 3) 
  ...
  ## NITRATE ### 
  #Water mass
  CairoPDF(file = "R.Figures/Metadata_distribution/Nitrate_ML_watermass.pdf", width = 5, height = 3) 
  ...
  #Region
   CairoPDF(file = "R.Figures/Metadata_distribution/Nitrate_ML_area.pdf", width = 5, height = 3)
  ...
  ## SILICATE ### 
  #Water mass
  CairoPDF(file = "R.Figures/Metadata_distribution/Silicate_ML_watermass.pdf", width = 5, height = 3) 
  ...
  #Region
   CairoPDF(file = "R.Figures/Metadata_distribution/Silicate_ML_area.pdf", width = 5, height = 3)
  ...
  ## CHLA ### - 
  #Water mass
  CairoPDF(file = "R.Figures/Metadata_distribution/Chla_ML_watermass.pdf", width = 5, height = 3) 
  ...
  #Region
   CairoPDF(file = "R.Figures/Metadata_distribution/Chla_ML_area.pdf", width = 5, height = 3)
...
DNA_metadata.surface %>%
  drop_na(RankChla) %>%
  ggplot(aes(x=RankChla, y=ChlaTot) ) + 
    geom_boxplot() + 
    coord_flip() 

ggplot(DNA_metadata.surface, aes(x=ChlaTot, color = Area)) + 
    geom_line(stat="density") +
    facet_grid(~RankChla, scales="free_x")
...
DNA_metadata.surface <- DNA_metadata.surface %>%
mutate(RankLat = cut(Lat, breaks=c(-30,-35,-40,-45, -50,-55,-60, -65, -70, -75), labels=c("-30","-35","-40","-45", "-50","-55","-60", "-65", "-70")))

DNA_metadata.surface$RankLat=as.factor(DNA_metadata.surface$RankLat)

  DNA_metadata.surface %>%
    drop_na(RankLat) 

    ggplot(DNA_metadata.surface, aes(x=RankLat, y=ChlaTot) ) + 
    geom_boxplot() + 
    coord_flip() +
    scale_x_discrete(limits = rev(unique(sort(DNA_metadata.surface$RankLat))))
```
...
df.sum <- DNA_metadata.surface %>%
  select(ChlaTot,NO3, DRSi, Temperature.CTD, Salinity.CTD, MLD0.2C, Lat) %>% # select variables to summarise
...
print(df.stats.tidy)
write.xlsx(df.stats.tidy, "Chla_Nut_Statistics_March2020")
```
